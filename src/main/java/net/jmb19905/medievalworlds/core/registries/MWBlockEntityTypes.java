...
import net.jmb19905.medievalworlds.common.blockentities.forge.ForgeControllerBlockEntity;
...
public class MWBlockEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<SimpleBloomeryBlockEntity>> SIMPLE_BLOOMERY = BLOCK_ENTITIES.register("bloomery", () -> BlockEntityType.Builder.of(SimpleBloomeryBlockEntity::new, MWBlocks.BLOOMERY.get()).build(null));
    public static final RegistryObject<BlockEntityType<AdvancedBloomeryBlockEntity>> ADVANCED_BLOOMERY = BLOCK_ENTITIES.register("advanced_bloomery", () -> BlockEntityType.Builder.of(AdvancedBloomeryBlockEntity::new, MWBlocks.BRICK_BLOOMERY.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<ForgeControllerBlockEntity>> FORGE = BLOCK_ENTITIES.register("forge", () -> BlockEntityType.Builder.of(ForgeControllerBlockEntity::new, MWBlocks.FORGE_BLOCK.get()).build(null));
