...
public class MWRecipeSerializers {
    ...
    private static final RecipeSerializer<AlloyRecipe> ALLOY_RECIPE_SERIALIZER = new AlloyRecipeSerializer();
    public static final RecipeType<IAlloyRecipe> ALLOY_TYPE = registerType(IAlloyRecipe.RECIPE_TYPE_ID);

    private static final RecipeSerializer<BloomRecipe> BLOOM_RECIPE_SERIALIZER = new BloomRecipeSerializer();
    public static final RecipeType<IBloomRecipe> BLOOM_TYPE = registerType(IBloomRecipe.RECIPE_TYPE_ID);

    private static final RecipeSerializer<ForgeRecipe> FORGE_RECIPE_SERIALIZER = new ForgeRecipeSerializer();
    public static final RecipeType<IForgeRecipe> FORGE_TYPE = registerType(IForgeRecipe.RECIPE_TYPE_ID);

    private static final RecipeSerializer<AnvilRecipe> ANVIL_RECIPE_SERIALIZER = new AnvilRecipeSerializer();
    public static final RecipeType<IAnvilRecipe> ANVIL_TYPE = registerType(IAnvilRecipe.RECIPE_TYPE_ID);

    private static final RecipeSerializer<GrindRecipe> GRIND_RECIPE_SERIALIZER = new GrindRecipeSerializer();
    ...
    public static final RegistryObject<RecipeSerializer<?>> GRIND_SERIALIZER = RECIPE_SERIALIZERS.register("grind", () -> GRIND_RECIPE_SERIALIZER);
