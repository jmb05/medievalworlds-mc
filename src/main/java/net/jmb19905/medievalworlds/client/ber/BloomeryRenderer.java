...
public class BloomeryRenderer implements BlockEntityRenderer<BloomeryBlockEntity> {
    ...
    @Override
    public void render(@NotNull BloomeryBlockEntity entity, float partialTicks, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int light, int overlay) {
