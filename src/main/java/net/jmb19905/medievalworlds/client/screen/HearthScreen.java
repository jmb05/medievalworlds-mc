...
public class HearthScreen extends AbstractContainerScreen<HearthMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(MedievalWorlds.MOD_ID, "textures/gui/hearth.png");
    private final HearthMenu screenMenu;

    public HearthScreen(HearthMenu screenMenu, Inventory inv, Component titleIn) {
    ...
    protected void renderBg(@Nonnull PoseStack stack, float partialTicks, int mouseX, int mouseY) {
        ...
        this.blit(stack, this.leftPos + 73, this.topPos + 35, 176, 14, screenMenu.getSmeltProgressionScaled(), 16);
        int x = leftPos + 39;
