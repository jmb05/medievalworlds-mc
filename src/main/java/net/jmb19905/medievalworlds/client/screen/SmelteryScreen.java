...
import net.jmb19905.medievalworlds.common.menus.SmelteryMenu;
...
public class SmelteryScreen extends AbstractContainerScreen<SmelteryMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(MedievalWorlds.MOD_ID, "textures/gui/smeltery.png");
    private final SmelteryMenu screenMenu;

    public SmelteryScreen(SmelteryMenu screenMenu, Inventory inv, Component titleIn) {
