...
public class TowerOutpostStructure extends Structure<NoFeatureConfig>
{
    public TowerOutpostStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return MedievalWorlds.MOD_ID + ":tower_outpost";
    }
    ...
    {
        return TowerOutpostStructure.Start::new;
    }
...
//		}
     ...
     *
     *
     * Also, please for the love of , do not do dimension checking here. If you do and another mod's dimension
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            TowerOutpostPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

            //Sets the bounds of the structure.
            this.recalculateStructureSize();

            //I use to debug and quickly find out if the structure is spawning or not and where it is.
            MedievalWorlds.LOGGER.log(Level.DEBUG, "Tower Outpost at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
