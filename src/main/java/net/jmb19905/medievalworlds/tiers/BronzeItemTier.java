...
public enum BronzeItemTier implements IItemTier {
    ...
    BronzeItemTier(int harvestLevel, int maxUses, float efficiency, float attackDamage, int enchantability, Supplier<Ingredient> repairMaterial){
