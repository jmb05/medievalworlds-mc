...
public enum TinArmorMaterial implements IArmorMaterial {
    ...
    private static final int[] MAX_DAMAGE_ARRAY = new int[]{14, 19, 17, 16};
    ...
    TinArmorMaterial(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability, SoundEvent soundEvent, float toughness, float knockbackResistance, Supplier<Ingredient> repairMaterial) {
        this.name = name;
