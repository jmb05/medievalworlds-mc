...
import net.jmb19905.medievalworlds.tileentites.BloomeryTileEntity;
...
public abstract class BloomeryBlock extends Block {
    ...
    public static class Bottom extends BloomeryBlock{
        ...
        public Bottom() {
            ...
            this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(CLAY, true).with(OPENED, false));
        }
    ...
    protected void fillStateContainer(@Nonnull StateContainer.Builder<Block, BlockState> builder) {
        ...
        builder.add(FACING, CLAY, OPENED);
    }
    ...
    private static final VoxelShape TOP_SHAPE = VoxelShapes.combineAndSimplify(Block.makeCuboidShape(2, 0, 1, 14, 10, 15), Block.makeCuboidShape(1, 0, 2, 15, 10, 14), IBooleanFunction.OR);
