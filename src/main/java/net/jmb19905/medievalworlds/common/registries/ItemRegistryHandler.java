...
public class ItemRegistryHandler {
    ...
    public static final RegistryObject<Item> IRON_LANCE = ITEMS.register("iron_lance", () -> new LanceItem(2.5f, 20, new Item.Properties().maxDamage(800).group(MedievalWorlds.itemGroup)));
    public static final RegistryObject<Item> SILVER_LANCE = ITEMS.register("silver_lance", () -> new LanceItem(2.75f, 15, new Item.Properties().maxDamage(600).group(MedievalWorlds.itemGroup)));
    public static final RegistryObject<Item> STEEL_LANCE = ITEMS.register("steel_lance", () -> new LanceItem(3f, 25, new Item.Properties().maxDamage(1000).group(MedievalWorlds.itemGroup)));
    public static final RegistryObject<Item> DIAMOND_LANCE = ITEMS.register("diamond_lance", () -> new LanceItem(3.25f, 20, new Item.Properties().maxDamage(1500).group(MedievalWorlds.itemGroup)));
    public static final RegistryObject<Item> NETHERITE_LANCE = ITEMS.register("netherite_lance", () -> new LanceItem(3.5f, 30, new Item.Properties().maxDamage(2000).group(MedievalWorlds.itemGroup)));
    ...
    public static final RegistryObject<Item> NETHERITE_HORSE_ARMOR = ITEMS.register("netherite_horse_armor", () -> new HorseArmorItem(20, new ResourceLocation("medievalworlds", "textures/entity/horse/armor/horse_armor_netherite.png"), (new Item.Properties()).maxStackSize(1).group(MedievalWorlds.itemGroup)));
