...
public class SilverCustomSword extends MWSwordWeapon implements ISilverWeapon {

    public SilverCustomSword(Tier tier, int attackDamage, float attackSpeed, float reachBonus, Properties properties) {
