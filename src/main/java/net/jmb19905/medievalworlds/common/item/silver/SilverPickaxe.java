...
public class SilverPickaxe extends PickaxeItem implements ISilverWeapon {

    public SilverPickaxe(Tier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
