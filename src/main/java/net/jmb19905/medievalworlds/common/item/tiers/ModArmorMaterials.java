...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ModArmorMaterials(String name, int[] maxDamageArray, int[] damageReductionAmountArray, int enchantmentValue, SoundEvent soundEvent, float toughness, float knockbackResistance, Supplier<Ingredient> repairMaterial) {
        this.name = name;
