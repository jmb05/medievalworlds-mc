...
public class SlackTubRecipeCategory extends MWRecipeCategory<SlackTubRecipe> {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull SlackTubRecipe recipe, @NotNull IFocusGroup focuses) {
