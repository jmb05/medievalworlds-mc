...
public class BloomRecipeCategory extends MWRecipeCategory<BloomRecipe>{
    public BloomRecipeCategory(IGuiHelper helper) {
        super(MWBlocks.SIMPLE_BLOOMERY.get(), MWJEIRecipeTypes.BLOOM, 0, 145, 91, 52, helper);
    }

    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull BloomRecipe recipe, @NotNull IFocusGroup focuses) {
