...
public class CustomSmithingRecipeCategory extends MWRecipeCategory<SmithingRecipe> {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull SmithingRecipe recipe, @NotNull IFocusGroup focuses) {
